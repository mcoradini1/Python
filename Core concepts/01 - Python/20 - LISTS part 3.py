...
#WITHOUT IT
squares_not_compreensive = []
for n in numbers:
    square = n ** 2
    squares_not_compreensive.append(square)
print(squares_not_compreensive)

#WITH IT 1
squares_compreensive = [n ** 2 for n in numbers ]
print(squares_compreensive)
...
# WITH IT 3 (list comprehension, including if and for, to sum the odd numbers from 0 through 9)

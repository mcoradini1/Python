'''
------------------------------------------------------------------------------------------------------------------------
Modules and Packages in 01 - Python
------------------------------------------------------------------------------------------------------------------------

Modules and packages are essential tools in 01 - Python for organizing and structuring code effectively.
...
Modules
------------------------------------------------------------------------------------------------------------------------
In 01 - Python, any file with a .py extension can be considered a module.Each module typically contains related functions,

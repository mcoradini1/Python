...
print(phrase.replace('01 - Python', 'Android')) #replace text
...
print(phrase.upper().find('language'))
...
#polimorphism: we can add to
b = 'hello' + 'world' #heloworld
s = 'python'
3*s #PythoPythonPython

new_s = s.replace('python', '01 - Python')  #Needs a new variable to store the new value (strings immutable)

# ======================================================================================================================
# CHALLENGE 111: Random Walk
# ======================================================================================================================

"""
Challenge: 9.2 - Random Walk (111)
...
Tags: import numpy, matplotlib, plt.hist, plt.show, cumsum, concatenate
Status: ✔️ Completed
"""
...
# This is almost done, I just need the cumulative section
# Example (2,4,1,3,2) -> 2,6,7,10,12

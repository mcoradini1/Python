# ======================================================================================================================
# CHALLENGE 53: PALINDROME: Check if a word is Palindrome (same reading backwards) (disconsider characters .,!? )
# ======================================================================================================================
#EXAMPLES TO CHECK: ''Doc note I dissent'' , ''Nurse I spy gypsies run''

"""
Challenge: 5.1.8 - PALINDROME (053)
Category: 5 - Loops
Concepts Used:
    - .strip()
    - .upper()
...
Tags:.strip(), .upper(), split(), .join() ,len() ,for, range()
Status: ✔️ Completed
"""

# ======================================================================================================================
# CHALLENGE 80: SORT manually: without using command .sort put a list in order.
# ======================================================================================================================

"""
Challenge: 6.2.3 - SORT manually (080)
...
Tags: list, .append(), for, enumerate(), if(), elif(), else(), range, while, break
Status: ✔️ Completed
"""
